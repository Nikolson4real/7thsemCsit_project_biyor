...
class ChickenObjectWidgetState extends State<ChickenObjectWidget> {
  ...
  // Future<void> onLocalObjectShuffleButtonPressed() async {
  //   if (this.localObjectNode != null) {
  //     // Rotation axis: Y-axis (spin left/right)
  //     final rotationAxis = Vector3(0, 1, 0);

  //     // Rotation amount (in radians) — 20 degrees
  //     final rotationAmount = 0.35; // ~20 degrees

  //     // Get current transform
  //     final currentTransform = localObjectNode!.transform.clone();

  //     // Apply rotation
  //     currentTransform.rotate(rotationAxis, rotationAmount);

  //     // Update the node
  //     this.localObjectNode!.transform = currentTransform;
  //   }
  // }

  // Future<void> onLocalObjectShuffleButtonPressed() async {
  //   if (this.localObjectNode != null) {
  //     final currentTransform = this.localObjectNode!.transform.clone();

  //     // Scale factor (1.1 = increase by 10%)
  ...
  Future<void> onLocalObjectShuffleButtonPressed() async {
    if (localObjectNode != null) {
      ...
      // Move by small amount on Z-axis
      const moveAmount = 0.1; // 10 cm in AR

      currentTransform.translate(Vector3(0, 0, -moveAmount));

      localObjectNode!.transform = currentTransform;
    }
  }
